...
module "subnets" {
  source = "git::https://github.com/ANIKETRS07/subnet-module.git"
...
module "ec2_instances" {
  source = "git::https://github.com/ANIKETRS07/ec2-module.git"
...
# ── S3 Bucket ────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "git::https://github.com/ANIKETRS07/s3-bucket.git"
